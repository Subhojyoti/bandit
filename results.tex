...
%%%
&\qquad\qquad+
\sum\limits_{\substack{i\in A_{s^{*}},\\0\leq\Delta_{i}\leq b}}\bigg\lbrace \dfrac{C_2(\rho_{a})T^{1-\rho_{a}}}{\Delta_{i}^{4\rho_{a}-1}}+\dfrac{C_2(\rho_a)T^{1-\rho_{a}}}{b^{4\rho_{a} -1}} \bigg\rbrace + \\
%%%%%%%
