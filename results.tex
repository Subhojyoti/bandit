...
&+ \sum_{i\in A\setminus A_{s^*}:\Delta_{i}> b }\dfrac{C_{2}(\rho_{s})T^{1-\rho_{s}}}{\Delta_{i}^{4\rho_{s}-1}} +\sum_{i\in A \setminus A_{s^*}: 0 < \Delta_{i} \leq b}\dfrac{C_{2}(\rho_{s})T^{1-\rho_{s}}}{b^{4\rho_{s}-1}}\\
