...
The theoretical analysis confirm this intuition, as choosing $\rho_a=\rho_s = \frac{1}{2}$ and $\psi_m=\frac{T}{\log (KT)}$, ClusUCB is able to achive a better gap-dependent regret upper bound as compared to UCB-Improved and MOSS (see Corollary \ref{Result:Corollary:1} in the next section). 
