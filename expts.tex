...
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt2/UCB1comp_subsampled.txt};
      \legend{ClusUCB-AE(p=1),ClusUCB(p=10),Med-Elim,UCB-Improved,MOSS,UCB1}
      \end{axis}
      \end{tikzpicture}}\\}
...
\centering
 ...
 \tabl{c}{\scalebox{0.7}{\begin{tikzpicture}
  ...
  legend style={at={(0.5,-0.2)},anchor=north, legend columns=4} ]
      % UCB
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCBNC_comp_subsampled.txt};
...
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCB7_comp_subsampled.txt};
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCB8_comp_subsampled.txt};
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCB9_comp_subsampled.txt};
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCB11_comp_subsampled.txt};
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCB13_comp_subsampled.txt};
\addplot table[x index=0,y index=1,col sep=tab,each nth point={10}] {results/Expt4_1/clUCB15_comp_subsampled.txt};
      \legend{ClusUCB(1),ClusUCB(3),ClusUCB(5),ClusUCB(7),ClusUCB(9),ClusUCB(11),  ClusUCB(13),ClusUCB(15)} 
      %\legend{ClusUCB (NC, p=1),ClusUCB (C, p=4),ClusUCB(C, p=10) ,MOSS, ClusUCB(C, p=5, NAE), ClusUCB(C, p=10, NAE)}
      %\legend{ClusUCB(1,A),ClusUCB(4,B),ClusUCB(10,B), MOSS,ClusUCB(5,S), ClusUCB(10,A)}
      \end{axis}
      \end{tikzpicture}}\\}
